...
<section class="hero">
    ...
    <div class="hero-content">
        <div class="hero-kicker">
            ...
            <span class="eyebrow">Benguet Highlands, Philippines</span>
        </div>
        ...
        <p class="hero-subtitle">
            Suspended above highland forest floors and perched over rushing mountain rivers — WildNest is the basecamp for your most unforgettable escape.
        </p>
...
<!-- ADVENTURE STRIP -->
<div class="adventure-strip">
    <div class="strip-track">
        <?php
        $items = ['Jungle Canopy Villas','River Cottages','Summit Suites','Guided Treks','Zip Lines','Forest Spa','Kayaking','Stargazing','Wildlife Walks','Bonfire Nights'];
        $double = array_merge($items, $items);
        foreach ($double as $item): ?>
            <div class="strip-item"><i class="fas fa-compass"></i> <?= $item ?> <div class="strip-dot"></div></div>
        <?php endforeach; ?>
    </div>
</div>
...
<section class="section">
    <div class="container">
        <div class="section-header">
            ...
            <p class="section-desc">From treetop villas draped in living ferns to riverside cottages with your feet over the water — each stay at WildNest is a room unlike any other.</p>
        </div>
            ...
            <div class="card">
                <div class="card-img-placeholder">
                    <?php if ($room['primary_image']): ?>
                        <img src="<?= SITE_URL ?>/assets/images/<?= htmlspecialchars($room['primary_image']) ?>" alt="<?= htmlspecialchars($room['name']) ?>" style="width:100%;height:100%;object-fit:cover">
                    <?php else: ?>
                        <i class="fas fa-mountain" style="font-size:4rem;color:var(--canopy);opacity:.3"></i>
                        <div style="position:absolute;inset:0;display:flex;align-items:center;justify-content:center;background:linear-gradient(135deg,var(--jungle-dark),var(--jungle-mid))">
...
<section class="section bg-jungle">
    <div class="container">
        <div class="section-header center">
            <div class="eyebrow" style="color:var(--ochre)">The WildNest Difference</div>
    ...
    <div class="container">
        ...
        <div class="grid-3">
            ...
            $testimonials = [
                ...
                ['Whitewater Cottage is perfect. We ate breakfast with our feet hanging over the river. The staff remembered our names by day two. WildNest feels like a family home, not a hotel.', 'Ana Lim', 'Singapore', 5],
            ];
...
<section style="background:var(--ochre);padding:5rem 0;text-align:center">
    <div class="container">
        ...
        <p style="font-size:1.1rem;color:rgba(255,255,255,.8);max-width:500px;margin:0 auto 2.5rem;line-height:1.7">Book your stay today and step into the highland wilderness. No two nights at WildNest are ever the same.</p>
